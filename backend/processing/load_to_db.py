...
def load_rooftops(database_path="../buildings.db"):
    """
...
def load_rooftops_sample(database_path="../buildings.db", limit=10000):
    """
    Load a sample of rooftop data for faster processing.
